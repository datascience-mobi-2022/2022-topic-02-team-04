...
The data analysis project revolves around RNA-seq data derived from the Cancer Genome Atlas. It gives an overview of the sample’s transcriptomes. RNA-seq data quantifies the transcripts DNA regions and therefore describes a good way to determine their relevance in specific samples, because the amount of reads of an RNA transcript determines the generation of certain proteins (Finotello and Di Camillo, 2014).
