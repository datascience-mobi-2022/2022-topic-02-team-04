...
The eleven upregulated gene sets differ in the gene set size as well as the Fold Change (Figure 9B). The gene set HALLMARK_MYC_TARGETS_V2 has the highest fold change of 0.848. However, this gene set contains 236 genes and is the largest of the upregulated gene sets and in total only 3.3% of the genes in the gene set are differentially expressed. The gene set HALLMARK_E2F_TARGETS has the second largest fold change with 0.751. Of the 218 genes 11.0% are upregulated. The gene sets HALLMARK_G2M_CHECKPOINT (13,7%), HALLMARK_ANDROGEN_RESPONSE (11.8 %) and HALLMARK_E2F_TARGETS (11.0%) contain the most differentially expressed genes.
