...
The RNA-seq data came in a log2(TPM) format serving as normalization technique. The original pan-cancer data frame, which contained 60,498 genes, was preprocessed according to Figure 1.
...
The study showed that using pathways for enrichment analysis is a promising tool for further analysis of cancer data. The main problem to face will be the loss of information since not every RNA's function is known yet or classified in any pathway. The existence of differences in PRAD samples compared to normal samples was confirmed. Future studies will show whether these information can be used for early detection of cancers or therapy. Furthermore, epigenetic alterations will be an increasing factor in cancer analysis. Upcoming studies can include epigenetic profiles as provided by "The Cancer Genome Atlas" [@RN38].
