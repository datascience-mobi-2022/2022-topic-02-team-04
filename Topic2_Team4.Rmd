...
$$
were computed for each combination. These result in a value between zero and one, which is the ratio between the intersection and union of the two respective pathways [@RN9]. After computing the Jaccard indices for every combination, a heatmap was created, which also clustered the gene sets.
