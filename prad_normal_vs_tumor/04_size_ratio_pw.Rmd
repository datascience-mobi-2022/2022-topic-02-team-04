...
percentage_diff_pw <- lapply(diff_pathways_ensID, function(x) size_ratio_pathway(pathway = x))

percentage_diff_pw <- unlist(percentage_diff_pw)

percentage_diff_pw <- sort(percentage_diff_pw, decreasing = TRUE)
