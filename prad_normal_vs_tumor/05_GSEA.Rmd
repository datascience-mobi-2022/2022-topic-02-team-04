...
dat_for_ranking <- data.frame(gene_number, neg_log10_p_value, log2_FoldChange)
```
...
duplicated_FC <- duplicated(log2_FoldChange)
...
dat_for_ranking$rank_FC <- rank(log2_FoldChange, ties.method = "random")
