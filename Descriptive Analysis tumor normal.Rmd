...
```{r}
par(mfrow = c(1,3))
qqnorm(mean_exp$normal, ylab = "normal", main = "qqnorm: Normal tissue")
qqnorm(mean_exp$tumor, ylab = "tumor", main = "qqnorm: Tumor tissue")
qqplot(mean_exp$tumor, mean_exp$normal, ylab = "normal", xlab = "tumor", main = "qqplot: Tumor vs. Normal")
par(mfrow = c(1,1))
```
