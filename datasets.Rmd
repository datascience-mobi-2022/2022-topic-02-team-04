...
```{r}
tcga_exp = readRDS("~/GitHub/2022-topic-02-team-04/datasets/tcga_tumor_log2TPM.RDS")
tcga_annot = readRDS("~/GitHub/2022-topic-02-team-04/datasets/tcga_tumor_annotation.RDS")
tcga_tumor_norm = readRDS("~/GitHub/2022-topic-02-team-04/datasets/tcga_tumor_normal_datascience_proj_2022.RDS")
genesets = readRDS("~/GitHub/2022-topic-02-team-04/datasets/hallmarks_genesets.rds")
```
